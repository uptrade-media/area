...
function HomePage() {
  ...
  // Navigation handler that changes section and scrolls to top
  const handleNavigation = (section) => {
    const map = {
      ...
      'acquisition-renovation': '/services/acquisition-and-renovation-financing',
  ...
  return (<>
      ...
      <meta name="description" content="Adams Real Estate Advisors structures construction loans, permanent mortgages, refinance solutions, and acquisition financing for commercial properties." />
