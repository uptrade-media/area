...
export default function RootLayout({ children }) {
  ...
  return (
    <html lang="en">
      <head>
        <title>Adams Real Estate Advisors - Commercial Real Estate Financing</title>
        <meta name="description" content="Premier commercial real estate financing solutions for developers and investors. Construction loans, permanent mortgages, and refinancing across the United States." />
      </head>
      <body>
        {/* Navigation */}
