      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#b9945a]/20 rounded-full mb-6 border border-[#b9945a]/30">
            ...
            <span className="text-[#b9945a] font-semibold">Grow Your Portfolio</span>
          </div>
          ...
          <p className="text-xl text-gray-300 leading-relaxed mb-12">
            Join our trusted network of commercial real estate lenders and access a steady pipeline of pre-qualified financing opportunities across all property types nationwide.
          </p>
