      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#b9945a]/20 rounded-full mb-6 border border-[#b9945a]/30">
            <Building className="h-5 w-5 text-[#b9945a]" />
            <span className="text-[#b9945a] font-semibold">Office Expertise</span>
          </div>
          ...
          <p className="text-xl text-gray-300 leading-relaxed mb-12">
            Specialized financing for office buildings, corporate parks, medical offices, and professional facilities. From Class A towers to suburban flex space, we secure optimal financing for office properties nationwide.
          </p>
