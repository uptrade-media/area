...
export default function PermanentMortgagesHero() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#b9945a]/20 rounded-full mb-6 border border-[#b9945a]/30">
            <Landmark className="h-5 w-5 text-[#b9945a]" />
            <span className="text-[#b9945a] font-semibold">Long-Term Financing</span>
          </div>
          
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            Permanent Mortgages for Commercial Properties
          </h1>
          
          <p className="text-xl text-gray-300 leading-relaxed mb-12">
            Secure long-term financing for stabilized, income-producing commercial real estate. Access competitive fixed and variable rates with flexible terms up to 30 years.
          </p>
