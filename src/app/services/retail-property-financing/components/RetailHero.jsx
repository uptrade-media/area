      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#b9945a]/20 rounded-full mb-6 border border-[#b9945a]/30">
            <ShoppingCart className="h-5 w-5 text-[#b9945a]" />
            <span className="text-[#b9945a] font-semibold">Retail Expertise</span>
          </div>
          ...
          <p className="text-xl text-gray-300 leading-relaxed mb-12">
            Specialized financing for shopping centers, strip malls, standalone retail buildings, and mixed-use properties with retail components. We understand retail real estate dynamics and tenant mix strategies.
          </p>
