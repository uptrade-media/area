        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button onClick={() => setActiveSection('home')} className={`capitalize px-3 py-2 rounded-md text-sm font-medium transition-colors ${activeSection === 'home' ? 'text-[#081c3e] bg-[#b9945a]/10' : 'text-gray-700 hover:text-[#081c3e] hover:bg-gray-50'}`}>Home</button>
              <div className="relative group">
                <button onClick={() => setActiveSection('services')} className={`capitalize px-3 py-2 rounded-md text-sm font-medium transition-colors ${activeSection === 'services' ? 'text-[#081c3e] bg-[#b9945a]/10' : 'text-gray-700 hover:text-[#081c3e] hover:bg-gray-50'}`}>Services</button>
              ...
              <button onClick={() => setActiveSection('about')} className={`capitalize px-3 py-2 rounded-md text-sm font-medium transition-colors ${activeSection === 'about' ? 'text-[#081c3e] bg-[#b9945a]/10' : 'text-gray-700 hover:text-[#081c3e] hover:bg-gray-50'}`}>About</button>
              <button onClick={() => setActiveSection('deals')} className={`capitalize px-3 py-2 rounded-md text-sm font-medium transition-colors ${activeSection === 'deals' ? 'text-[#081c3e] bg-[#b9945a]/10' : 'text-gray-700 hover:text-[#081c3e] hover:bg-gray-50'}`}>Transactions</button>
              <button onClick={() => setActiveSection('contact')} className={`capitalize px-3 py-2 rounded-md text-sm font-medium transition-colors ${activeSection === 'contact' ? 'text-[#081c3e] bg-[#b9945a]/10' : 'text-gray-700 hover:text-[#081c3e] hover:bg-gray-50'}`}>Contact</button>
              <button onClick={() => setActiveSection('lender-program')} className={`capitalize px-3 py-2 rounded-md text-sm font-medium transition-colors ${activeSection === 'lender-program' ? 'text-[#081c3e] bg-[#b9945a]/10' : 'text-gray-700 hover:text-[#081c3e] hover:bg-gray-50'}`}>Lender Program</button>
            </div>
            ...
            <div className="md:hidden">
              <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
                ...
                {services.map((service) => (
                  <button 
                    key={service.id}
                    onClick={() => {setActiveSection(service.id); setMobileMenuOpen(false)}} 
                ...
                <button 
                  onClick={() => {setActiveSection('deals'); setMobileMenuOpen(false)}} 
                ...
                <button 
                  onClick={() => {setActiveSection('lender-program'); setMobileMenuOpen(false)}} 
      ...
      <section className="py-20 bg-[#b9945a]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" className="bg-white text-[#b9945a] hover:bg-gray-100 px-8 py-4 text-lg font-semibold" onClick={() => setActiveSection('contact')}>
              Get Started Today
            </Button>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-r from-[#081c3e] to-[#1a365d] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-[#b9945a] hover:bg-[#a5834f] px-8 py-4 text-lg" onClick={() => setActiveSection('contact')}>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {services.map((service) => (
                <li key={service.id}>
                  <button onClick={() => setActiveSection(service.id)} className="text-gray-400 hover:text-white">{service.title}</button>
                </li>
              ))}
            </ul>
          </div>
